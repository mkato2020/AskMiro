...
<div class="modal-body">
  ...
  function generateClientEmail(d) {
    ...
    return '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0">'
      ...
      + '<div style="font-family:' + F + ';font-size:10px;color:rgba(255,255,255,0.7);letter-spacing:1.6px;text-transform:uppercase;margin-top:3px">Professional Cleaning Across London</div>'
      + '</td></tr></table></td>'
      ...
      + '<span style="font-family:' + F + ';font-size:11px;font-weight:600;color:rgba(255,255,255,0.85);letter-spacing:0.6px">Booking Confirmation</span></div></td>'
      + '</tr></table></td></tr>'
      // Body
      ...
      + (d.jobDateShort ? '<table cellpadding="0" cellspacing="0" width="100%" style="margin:0 0 28px;border-radius:12px;overflow:hidden;background:' + C.navy + '"><tr>'
        ...
        + '<div style="font-family:' + F + ';font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.3px;color:rgba(255,255,255,0.7);margin-bottom:6px">Date</div>'
        ...
        + '<div style="font-family:' + F + ';font-size:11px;color:rgba(255,255,255,0.6);margin-top:5px">' + _escHtml(d.jobDay) + '</div></td>'
        + '<td align="center" style="padding:22px 18px;border-right:1px solid rgba(255,255,255,0.07)">'
        + '<div style="font-family:' + F + ';font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.3px;color:rgba(255,255,255,0.7);margin-bottom:6px">Time</div>'
        ...
        + '<div style="font-family:' + F + ';font-size:11px;color:rgba(255,255,255,0.6);margin-top:5px">Start time</div></td>'
        + '<td align="center" style="padding:22px 18px">'
        + '<div style="font-family:' + F + ';font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.3px;color:rgba(255,255,255,0.7);margin-bottom:6px">Total</div>'
        ...
        + '<div style="font-family:' + F + ';font-size:11px;color:rgba(255,255,255,0.6);margin-top:5px">All-inclusive</div></td>'
        + '</tr></table>' : '')
      // Property callout
  ...
  function generateCompletionEmail(d) {
    ...
    return '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0">'
      ...
      + '</td></tr></table></td>'
      + '<td align="right" style="vertical-align:middle"><div style="display:inline-block;background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.11);border-radius:20px;padding:6px 16px">'
      + '<span style="font-family:' + F + ';font-size:11px;font-weight:600;color:rgba(255,255,255,0.85);letter-spacing:0.6px">Job Complete</span></div></td>'
      + '</tr></table></td></tr>'
      // Body
      + '<tr><td style="background:#FFFFFF;padding:44px 40px 36px;border-left:1px solid ' + C.border + ';border-right:1px solid ' + C.border + '">'
      ...
      + '<div style="font-family:' + F + ';font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.3px;color:rgba(255,255,255,0.7);margin-bottom:6px">Service</div>'
  ...
  function generatePaymentEmail(d) {
    ...
    return '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0">'
      ...
      + '</td></tr></table></td>'
      + '<td align="right" style="vertical-align:middle"><div style="display:inline-block;background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.11);border-radius:20px;padding:6px 16px">'
      + '<span style="font-family:' + F + ';font-size:11px;font-weight:600;color:rgba(255,255,255,0.85);letter-spacing:0.6px">Payment Receipt</span></div></td>'
      + '</tr></table></td></tr>'
      // Body
      + '<tr><td style="background:#FFFFFF;padding:44px 40px 36px;border-left:1px solid ' + C.border + ';border-right:1px solid ' + C.border + '">'
      // Green paid banner
  ...
  function generateReminderEmail(d) {
    ...
    return '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0">'
      ...
      + '</td></tr></table></td>'
      + '<td align="right" style="vertical-align:middle"><div style="display:inline-block;background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.11);border-radius:20px;padding:6px 16px">'
      + '<span style="font-family:' + F + ';font-size:11px;font-weight:600;color:rgba(255,255,255,0.85);letter-spacing:0.6px">Booking Reminder</span></div></td>'
      + '</tr></table></td></tr>'
      // Body
      + '<tr><td style="background:#FFFFFF;padding:44px 40px 36px;border-left:1px solid ' + C.border + ';border-right:1px solid ' + C.border + '">'
